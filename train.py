...
if __name__ == "__main__":
    ...
    parser.add_argument('--weights','-w',type=str,default='',help='initial weights path 初始权重的乌贼骨')
    parser.add_argument('--freeze','-f',action='store_true',help='表示是否冻结训练')
    parser.add_argument('--freeze-epochs','-fe',type=int,default=50,help='epochs for feeze 冻结训练的呆呆次数')
